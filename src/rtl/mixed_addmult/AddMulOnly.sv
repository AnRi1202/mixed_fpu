...
module AddMulOnly(
    ...
    assign add_fracAdder_Y_eff = (fmt == FMT_FP16) ? (add_fracAdder_Y + cin_vec_add) : add_fracAdder_Y;
    ...
    assign norm_h = (fmt ==FMT_FP16) ? sigProd[49] : sigProd[47];
    assign norm_l = (fmt ==FMT_FP16) ? sigProd[15]: 1'b0;
